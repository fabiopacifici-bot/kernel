...
def build_system_prompt(config: dict, skills: list, routines: list, vram_free_fn=None, channel: str = "unknown", sender_name: str = "", agent_ready: bool = True) -> str:
    ...
    lines += [
        "",
        "## Your capabilities",
        "You have 6 tools available for EVERY request — use them proactively:",
        ...
        "  • run_skill(skill_name, input) — Execute any installed skill by name. ALWAYS prefer this over reimplementing skill logic with exec_shell.",
